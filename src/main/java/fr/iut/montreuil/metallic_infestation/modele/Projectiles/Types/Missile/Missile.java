...
public abstract class Missile extends Projectile {
    public Missile(Point coordonees, Point cible, int vitesse, int rayonProjectile, int durabilite, int degats, int rayonExplosion,int idType){
        super(coordonees, cible, vitesse, rayonProjectile, durabilite,idType);
